...
db = "CSSE-time-series-covid19-cr-2020-10-27.db"
...
def home():
    ...
    return render_template("home.html", locales=db_get_locales(), message="Please enter a locale to search for.",
                           options=options)
...
def db_get_locales():
    ...
    table = "time_series_confirmed"
    stmt = "SELECT `Country/Region` from " + table
